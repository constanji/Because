...
import PromptsPanel from "./Input/PromptsPanel";
            ...
            <div className="flex h-full w-full flex-col">
              ...
              <>
                ...
                >
                  ...
                  >
                    {isLandingPage && <PromptsPanel />}
                    <ChatForm index={index} />
                    {isLandingPage ? (
                      <ConversationStarters />
                    ) : (
                      <div className="2">
                        <Footer className="relative left-0 right-0 hidden items-center justify-center gap-2 px-2 py-2 text-center text-sm text-text-primary sm:flex md:px-[60px]" />
                      </div>
                    )}
                  </div>
                </div>
